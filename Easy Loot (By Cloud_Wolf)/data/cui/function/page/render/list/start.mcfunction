...
execute if score #bool cui matches 1 run function cui:page/render/list/new_list
...
execute if score .render-idx cui <= .render-max cui run function cui:general/get_idx with storage cui render.list
...
execute if score .render-idx cui < .render-max cui run function cui:page/render/list/set_lore with storage cui render.list
