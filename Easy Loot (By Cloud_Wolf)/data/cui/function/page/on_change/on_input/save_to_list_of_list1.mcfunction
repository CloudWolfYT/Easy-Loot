...
$execute unless data $(source1)[$(idx1)].$(source)[$(idx)] run data modify $(source1)[$(idx1)].$(source) append from storage cui in[-1]
$data modify storage cui in[-1].Slot set from $(source1)[$(idx1)].$(source)[$(idx)].Slot
$data modify $(source1)[$(idx1)].$(source)[$(idx)] set from storage cui in[-1]
