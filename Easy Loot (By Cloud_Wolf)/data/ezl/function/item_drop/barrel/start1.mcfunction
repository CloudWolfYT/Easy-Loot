...
function ezl:item_drop/barrel/place_vec
execute if score .x ezl matches 0 if score .z ezl matches 0 run function ezl:item_drop/barrel/place_rot

data modify storage ezl:temp in set from entity @s Item.components."minecraft:custom_data".ezl

execute summon marker run function ezl:item_drop/barrel/spawn
